...
-Character in python is treated as string of length 1.
-The output string is enclosed in double quotes only if the input string given only single quotes.
-Indexing is used to obtain individual string whereas slicing is used to obtain a substring.
"""
