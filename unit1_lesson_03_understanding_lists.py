...
-List is a datatype which can contain items of all types.i.e no need to have all items of same type
-List manipulation functions like append,insert doesnot work with strings.
-List is mutable
"""