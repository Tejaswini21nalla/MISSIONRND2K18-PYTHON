...
def test_nested_exceptions():
    ...
    # not get this to work.
        #first inner try gets executed and as it is raising error inner except os executed
        #in the inner except there is again raise of exception it jumps directly to finally block
        #in the finally block we have an exception it executes outer except block
        #ae contains inner error
        #ax contains error in finally
