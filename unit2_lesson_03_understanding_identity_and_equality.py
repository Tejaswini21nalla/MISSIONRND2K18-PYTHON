...
-Python objects has unique identity,type,content.
-Object name is replaced but content of the object cannot be replaced.
-IS is true or applicable for integers between range 0 to 256
"""
